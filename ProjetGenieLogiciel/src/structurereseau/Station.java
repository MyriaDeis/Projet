...
public class Station implements Serializable {
	...
	public ArrayList<Fragment> chemin(ArrayList<Fragment> parcours, Station but) { // parcours : effectu� jusqu'� pr�sent
	...
	public int tempsEntre2Stations(Station but) {
		int res = 0;
		for (Fragment f : chemin(null, but)) // appel de la m�thode qui trouve le chemin entre 2 stations
